...
def args_setup():
    ...
    parser.add_argument('--d', metavar='DATE', type=str, help='Date of detection that ALerCE database is queried. Formatted as YYYY-MM-DD (default: Current date)', default=datetime.today().strftime("%Y-%m-%d"))
